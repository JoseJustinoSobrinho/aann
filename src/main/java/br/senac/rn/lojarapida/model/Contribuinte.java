...
public class Contribuinte implements Serializable {
    ...
    @ManyToOne
    private DataMensageiro dataMansageiro;  // corrigir data mensageiro
    @ManyToOne
    private Turno turno;
    ...
    public Contribuinte(int id, String nome, Sexo sexo, Calendar datNasc, int idade, Cidade codNatural, String cpf, String rg, Expedidor codExpedidor, String pai, String mae, EstadoCivil codEstadoCivil, String conjuge, String fixo, String oi, String claro, String tim, String vivo, String outroTele, String watts, String email, String cartaoSus, Profissao codProfissaoPrinc, List<Profissao> codProfissao, String titulo, String zona, String secao, String mesPago, String outroFim, DataMensageiro dataMansageiro, Turno turno, String pendencia, String carteira, String prontuario, Cep cep, Complemento complemento, int casa, String casaB, Status status, Categoria categoria, Escolaridade escolaridade, Mensageiro mensageiro, List<Grupo> grupo, LocVotacao locVotacao, String lembrete, String obs, Calendar cadastro) {
        this.id = id;
        this.nome = nome;
        this.sexo = sexo;
        ...
        this.dataMansageiro = dataMansageiro;
        this.turno = turno;
    ...
    public Contribuinte(String nome, Sexo sexo, Calendar datNasc, int idade, Cidade codNatural, String cpf, String rg, Expedidor codExpedidor, String pai, String mae, EstadoCivil codEstadoCivil, String conjuge, String fixo, String oi, String claro, String tim, String vivo, String outroTele, String watts, String email, String cartaoSus, Profissao codProfissaoPrinc, List<Profissao> codProfissao, String titulo, String zona, String secao, String mesPago, String outroFim, DataMensageiro dataMansageiro, Turno turno, String pendencia, String carteira, String prontuario, Cep cep, Complemento complemento, int casa, String casaB, Status status, Categoria categoria, Escolaridade escolaridade, Mensageiro mensageiro, List<Grupo> grupo, LocVotacao locVotacao, String lembrete, String obs, Calendar cadastro) {
        this.nome = nome;
        this.sexo = sexo;
        this.datNasc = datNasc;
        this.idade = idade;
    ...
    public DataMensageiro getDataMansageiro() {
        return dataMansageiro;
    }

    public void setDataMansageiro(DataMensageiro dataMansageiro) {
        this.dataMansageiro = dataMansageiro;
    }
